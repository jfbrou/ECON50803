...
\begin{reponse}
\textbf{Faux.} Le PIB par habitant est un indicateur \textbf{imparfait} du bien-être. Il ne tient pas compte de la \textbf{distribution} des revenus (inégalités), du \textbf{travail non rémunéré}, de la \textbf{qualité de l'environnement}, des \textbf{loisirs} ou de la \textbf{santé}. Le mot \guillemotleft~nécessairement~\guillemotright\ est donc trop fort : un pays riche mais très inégalitaire peut offrir un niveau de vie inférieur à la majorité de sa population. Exemple : le Qatar a un PIB par habitant parmi les plus élevés au monde, mais le niveau de vie de ses travailleurs migrants est très faible.
\end{reponse}
