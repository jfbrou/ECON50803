...
\qcm{Il est plus juste d'utiliser le ratio $K/Y$ plutôt que $K/L$ dans la décomposition du PIB par habitant. Pourquoi?}
\choix{
   ...
   \item Parce que $K/Y$ est exprimé dans les mêmes unités que le PIB par habitant ($Y/N$)
...
\begin{reponse}
\textbf{Incertain.} Le modèle de Solow prédit la convergence uniquement entre pays qui partagent les mêmes \textbf{fondamentaux} (institutions, éducation, taux d'épargne). C'est la convergence \textbf{conditionnelle}. On l'observe entre les États américains et au sein de l'OCDE, mais \textbf{pas} entre tous les pays du monde. Plusieurs pays pauvres stagnent depuis des décennies en raison d'institutions faibles, de conflits ou de mauvaise gouvernance. Toutefois, il est possible que ces pays finissent par rattraper les riches si leurs fondamentaux s'améliorent, mais ce n'est pas garanti.
\end{reponse}
