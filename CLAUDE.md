...
- English language (Vincent's originals are in French)
...
│   ├── S1/s1.tex          # Session 1 slides (49 pages)
│   ├── S2/                # Sessions 2-6 (to be created)
│   ├── S3/
│   ├── S4/
│   ├── S5/
│   └── S6/
...
Each session compiles independently from its own directory:
...
- Footer shows "ECON50803 | Macroeconomic Environment" + slide number
- `\graphicspath{{../Figures/}}` -- All figures go in shared Figures/ directory
...
### Session 1 (completed)
- 49 slides, covers GDP + inflation + living standards + 2026 landscape
...
- ~15 figure placeholders with TODO comments
