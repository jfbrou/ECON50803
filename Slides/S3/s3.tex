...
\begin{frame}[t]{Pourquoi l'impact tarde-t-il\,?}
   \framesubtitle{La réorganisation prend du temps}
   \small
   Les révolutions technologiques ne se traduisent pas instantanément en productivité :
   \vspace{0.15cm}
   \begin{itemize}
      \setlength\itemsep{0.15cm}
      \item \textbf{Moteurs électriques} (début XX\textsuperscript{e}) : gains uniquement après reconfiguration des usines pour exploiter la flexibilité du moteur individuel
      \item \textbf{Ordinateurs} (années 1980--90) : productivité accélère seulement après l'émergence de nouveaux modèles d'affaires (logistique, commerce en ligne)
   \end{itemize}
   \vspace{0.1cm}
   \begin{keyinsight}[Le paradoxe de Solow]
      En 1987, Robert Solow écrivait : \guillemotleft~\textit{On voit des ordinateurs partout, sauf dans les statistiques de productivité.}\guillemotright{} La même chose se produit avec l'IA. Les gains de productivité n'apparaîtront que lorsque les entreprises \textbf{réorganisent le travail}.
   \end{keyinsight}
\end{frame}
...
\begin{frame}[t]{Faut-il s'inquiéter de la montée des inégalités\,?}
   ...
   \begin{itemize}
      \setlength\itemsep{0.1cm}
      \item Un certain niveau d'inégalité est nécessaire aux incitatifs économiques
   ...
   \begin{itemize}
      \setlength\itemsep{0.1cm}
      \item L'inégalité des résultats est associée à une faible \textbf{mobilité économique}
      \item L'inégalité des chances nous prive de nos \textbf{meilleurs talents}
   \end{itemize}
   \vspace{0.1cm}
   \begin{keyinsight}[Pauvreté vs.\ inégalité]
      La \textbf{pauvreté} est absolue; l'\textbf{inégalité} est relative. Pourquoi alors se soucier autant des inégalités\,?
   \end{keyinsight}
\end{frame}
