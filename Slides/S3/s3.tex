...
\begin{frame}{Impacts sur le marché du travail}
   ...
   \begin{tikzpicture}
      ...
      \begin{scope}
         \draw[-{Stealth}, thick] (0,0) -- (5,0) node[right] {$L$};
         \draw[-{Stealth}, thick] (0,0) -- (0,4) node[above] {$w$};
         \node[font=\bfseries] at (2.5,4.5) {Travail non qualifié};
         % Supply: y = 0.75x + 0.125
         \draw[HECnavy, very thick] (0.5,0.5) -- (4.5,3.5) node[right, font=\small] {$L^S$};
         % Old demand (faded): y = -0.75x + 3.875
         \draw[HECgray, dashed, thick] (0.5,3.5) -- (4.5,0.5) node[right, font=\small] {$L^D$};
         % New demand (shifted left by 1.5): y = -0.75x + 2.75
         \draw[HECcoral, very thick] (0.33,2.5) -- (3.33,0.25) node[right, font=\small] {$L^{D\prime}$};
         % Old equilibrium: (2.5, 2.0)
         \filldraw[HECgray] (2.5,2) circle (2.5pt);
         \draw[dotted, thick, HECgray] (2.5,0) -- (2.5,2);
         \draw[dotted, thick, HECgray] (0,2) -- (2.5,2);
         \node[font=\footnotesize, below] at (2.5,0) {$L_0$};
         \node[font=\footnotesize, left] at (0,2) {$w_0$};
         % New equilibrium: intersection of S and D'
         % 0.75x + 0.125 = -0.75x + 2.75 → x = 1.75, y = 1.4375
         \filldraw[HECcoral] (1.75,1.44) circle (3pt);
         \draw[dotted, thick, HECgray] (1.75,0) -- (1.75,1.44);
         \draw[dotted, thick, HECgray] (0,1.44) -- (1.75,1.44);
         \node[font=\footnotesize, below] at (1.75,0) {$L_1$};
         \node[font=\footnotesize, left] at (0,1.44) {$w_1$};
         % Demand shift arrow (between curves, at y=1.0)
         % On old D at y=1.0: x = (3.875-1.0)/0.75 = 3.83
         % On new D at y=1.0: x = (2.75-1.0)/0.75 = 2.33
         \draw[-{Stealth[length=5pt]}, HECcoral, thick] (3.6,1.0) -- (2.6,1.0);
      \end{scope}
      % ── Graph 2: Skilled Labor ──
      \begin{scope}[xshift=7cm]
         \draw[-{Stealth}, thick] (0,0) -- (5,0) node[right] {$L$};
         \draw[-{Stealth}, thick] (0,0) -- (0,4) node[above] {$w$};
         \node[font=\bfseries] at (2.5,4.5) {Travail qualifié};
         % Supply: y = 0.75x + 0.125
         \draw[HECnavy, very thick] (0.5,0.5) -- (4.5,3.5) node[right, font=\small] {$L^S$};
         % Old demand (faded): y = -0.75x + 3.875
         \draw[HECgray, dashed, thick] (0.5,3.5) -- (4.5,0.5) node[right, font=\small] {$L^D$};
         % New demand (shifted right by 1.5): y = -0.75x + 5.0
         \draw[HECgreen, very thick] (1.33,4.0) -- (5.33,1.0) node[right, font=\small] {$L^{D\prime}$};
         % Old equilibrium: (2.5, 2.0)
         \filldraw[HECgray] (2.5,2) circle (2.5pt);
         \draw[dotted, thick, HECgray] (2.5,0) -- (2.5,2);
         \draw[dotted, thick, HECgray] (0,2) -- (2.5,2);
         ...
         \filldraw[HECgreen] (3.25,2.56) circle (3pt);
         \draw[dotted, thick, HECgray] (3.25,0) -- (3.25,2.56);
         \draw[dotted, thick, HECgray] (0,2.56) -- (3.25,2.56);
         \node[font=\footnotesize, below] at (3.25,0) {$L_1$};
         \node[font=\footnotesize, left] at (0,2.56) {$w_1$};
         % Demand shift arrow (between curves, at y=1.0)
         % On old D at y=1.0: x = (3.875-1.0)/0.75 = 3.83
         % On new D at y=1.0: x = (5.0-1.0)/0.75 = 5.33
         \draw[-{Stealth[length=5pt]}, HECgreen, thick] (4.0,1.0) -- (5.0,1.0);
      \end{scope}
   \end{tikzpicture}
\end{frame}
