   ...
   \begin{columns}[T]
      ...
      \begin{column}{0.48\textwidth}
         ...
         \begin{tikzpicture}[scale=0.85]
            \draw[-{Stealth}, thick] (0,0) -- (5,0) node[right] {$N$};
            \draw[-{Stealth}, thick] (0,0) -- (0,4.5) node[above] {$w$};
            \draw[HECnavy, very thick] (0.5,0.5) -- (4,3.5) node[right] {$N^S$};
            \draw[HECgreen, very thick, dashed] (1.5,0.5) -- (5,3.5)
               node[right, font=\small] {$N^{S\prime}$};
            \draw[-{Stealth}, HECgreen, thick] (2.5,2.2) -- (3.5,2.2);
         \end{tikzpicture}
         \vspace{0.1cm}

         {\footnotesize\textcolor{HECgray}{$\uparrow$ population $\to$ $N^S$ se déplace à droite}}
      \end{column}
   \end{columns}
\end{frame}
   ...
   \begin{columns}[T]
      ...
      \begin{column}{0.48\textwidth}
         ...
         \begin{tikzpicture}[scale=0.85]
            \draw[-{Stealth}, thick] (0,0) -- (5,0) node[right] {$N$};
            \draw[-{Stealth}, thick] (0,0) -- (0,4.5) node[above] {$w$};
            \draw[HECcoral, very thick] (0.5,4) -- (4.5,0.5) node[right] {$N^D$};
            \draw[HECgreen, very thick, dashed] (1.5,4.5) -- (5.5,1)
               node[right, font=\small] {$N^{D\prime}$};
            \draw[-{Stealth}, HECgreen, thick] (2.5,2.2) -- (3.5,2.2);
         \end{tikzpicture}
         \vspace{0.1cm}

         {\footnotesize\textcolor{HECgray}{$\uparrow$ productivité $\to$ $N^D$ se déplace à droite}}
      \end{column}
   \end{columns}
\end{frame}
   ...
   \begin{columns}[T]
      ...
      \begin{column}{0.48\textwidth}
         ...
         \begin{tikzpicture}[scale=0.85]
            ...
            \draw[dashed, HECgray] (2.35,0) node[below] {$N^*$} -- (2.35,2.15);
   ...
   \begin{columns}[T]
      \begin{column}{0.48\textwidth}
         ...
         \begin{itemize}
            ...
            \item Un choc d'offre (ex.\ immigration) modifie $w$ et $N$
         \end{itemize}
      \end{column}
      \begin{column}{0.48\textwidth}
         ...
         \begin{itemize}
            ...
            \item $K \uparrow$ $\to$ $N^D$ se déplace à droite
         \end{itemize}
      \end{column}
   \end{columns}
   \vspace{0.3cm}
   \begin{defbox}
      \textbf{Court terme :} $K$ fixe, seul $N$ s'ajuste.\\
...
\begin{frame}{Le modèle en action}
   ...
   \end{enumerate}
   \vspace{0.3cm}
   Dans chaque cas : quel choc? Quelle courbe se déplace? Quel effet sur $w$ et $N$?
\end{frame}
...
\begin{frame}[t]{La participation des femmes}
   \begin{columns}[T]
      ...
      \begin{column}{0.47\textwidth}
         \small
         \textbf{Le choc :} déplacement massif de $N^S$ vers la droite (1960--2000).
         \vspace{0.15cm}

         \textbf{Court terme :}
         \begin{itemize}
            \setlength\itemsep{0.05cm}
            \item Plus de travailleurs $\to$ $N \uparrow$
         ...
         \begin{itemize}
            \setlength\itemsep{0.05cm}
            \item $K$ s'ajuste $\to$ $N^D$ se déplace
...
\begin{frame}[t]{Le vieillissement démographique}
   \begin{columns}[T]
      ...
      \begin{column}{0.47\textwidth}
         \small
         \textbf{Le choc :} déplacement de $N^S$ vers la \textbf{gauche} (moins de travailleurs en âge actif).
         \vspace{0.15cm}
...
\begin{frame}[t]{Immigration : le court terme}
   \begin{columns}[T]
      ...
      \begin{column}{0.48\textwidth}
         ...
         \begin{itemize}
            \setlength\itemsep{0.15cm}
            \item $N^S$ se déplace à \textbf{droite}
   ...
   \begin{columns}[T]
      \begin{column}{0.48\textwidth}
         ...
         \begin{tikzpicture}[scale=0.85]
            ...
            \draw[HECnavy, very thick] (1.5,0.5) -- (5,3.5) node[right] {$N^{S\prime}$};
            % Original demand
            \draw[HECgray, thick, dashed] (0.5,4) -- (4.5,0.5)
               node[right, font=\small, text=HECgray] {$N^D$};
            % SR equilibrium
   ...
   \begin{columns}[T]
      \begin{column}{0.53\textwidth}
         ...
         \begin{itemize}
            ...
            \item $N^D_{\text{qualifiés}} \uparrow$ et $N^D_{\text{non-qualifiés}} \downarrow$
         \end{itemize}
         \vspace{0.1cm}
...
\begin{frame}[t]{Résumé}
   \begin{keyinsight}[Les leçons du marché du travail]
      \begin{enumerate}
         \setlength\itemsep{0.15cm}
         \item Le marché du travail s'analyse comme tout marché : \textbf{offre}, \textbf{demande}, \textbf{équilibre}
         \item Le capital s'ajuste à long terme --- l'immigration \textbf{ne déprime pas} les salaires de façon permanente
...
\begin{frame}[t]{Avant la prochaine séance}
   ...
   \begin{itemize}
      ...
      \item Branko Milanovic, \textit{Global Inequality} (chapitres 1--2)
   \end{itemize}
   \vspace{0.3cm}
   ...
   \begin{tcolorbox}[
      ...
      L'IA générative (ChatGPT, Claude, etc.) remplace-t-elle surtout des tâches \textbf{routinières cognitives} ou des tâches \textbf{non routinières cognitives}? Quelles implications pour le marché du travail canadien?
   \end{tcolorbox}
   \vspace{0.3cm}
