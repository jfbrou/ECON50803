"""
ECON50803 — Session 1 : Figure Generation (French)
====================================================

Generates the narrative-arc figures for the French version of Session 1 slides.
All figure labels, axis titles, legends, and annotations are in French.
Data sources and plot mechanics are identical to the English version.

Run from Slides/S1/FR/:
    python3 figures_s1_fr.py
"""
...
# ── Output path ─────────────────────────────────────────────────────────
FIGURES_DIR = os.path.join(Path(__file__).resolve().parent.parent.parent, 'Figures_FR')
...
def us_tariff_rate():
    ...
    ax.annotate(f'{etr_2025_overall:.1f}\\%  global',
                ...
                fontsize=11, color=palette[2], fontweight='bold',
                arrowprops=dict(arrowstyle='->', color=palette[2], lw=1.5))
    ax.annotate(f'{etr_2025_canada:.1f}\\%  sur les biens canadiens',
