...
\begin{frame}{Le choc d'offre : Ormuz et le pétrole}
   ...
   \begin{tikzpicture}[scale=1.2]
      ...
      \draw[HECgreen, very thick, dotted] (3.0,0) -- (3.0,4.2)
         node[above] {$Y_{\text{POT}}$};
      % AD original (stays in place): y = -0.6x + 4.1
      ...
      \draw[-{Stealth[length=4pt]}, HECcoral, thick] (4.5,3.2) -- (2.83,3.2);
      \node[font=\footnotesize, HECcoral, above] at (4,3.2) {\textbf{beaucoup}};
      % Original equilibrium at (3.0, 2.3)
      \filldraw[HECgray] (3.0,2.3) circle (2.5pt);
      \draw[dotted, very thick, HECgray] (0,2.3) node[left] {$P^*$} -- (3.0,2.3);
      % New equilibrium: AD ∩ AS' → x=2.17, y=2.80
      \filldraw[HECcoral] (2.17,2.80) circle (3pt);
      \draw[dotted, very thick, HECgray] (2.17,0) node[below] {$Y'$} -- (2.17,2.80);
      \draw[dotted, very thick, HECgray] (0,2.80) node[left] {$P'$} -- (2.17,2.80);
   \end{tikzpicture}
\end{frame}
...
\begin{frame}{Scénario A : Pétrole cher $\to$ aubaine pour les exportateurs}
   ...
   \begin{tikzpicture}[scale=1.2]
      ...
      \draw[HECgray, dashed, thick] (0.5,0.8) -- (5.5,3.8)
         node[right, font=\footnotesize] {AS};
      % AD' shifted slightly right: y = -0.6x + 4.5
      \draw[HECnavy, very thick] (0.5,4.2) -- (5.83,1.0)
         node[right] {AD$'$};
      % AS' shifted a lot left: y = 0.6x + 1.5
      \draw[HECcoral, very thick] (0.5,1.8) -- (5.0,4.5)
         node[right] {AS$'$};
      ...
      \draw[-{Stealth[length=4pt]}, HECnavy, thick] (4.33,1.5) -- (5.0,1.5);
      \node[font=\footnotesize, HECnavy, above] at (4.3,1.5) {\textit{peu}};
      % Large AS shift arrow: from AS to AS' at y=3.2
      \draw[-{Stealth[length=4pt]}, HECcoral, thick] (4.5,3.2) -- (2.83,3.2);
      \node[font=\footnotesize, HECcoral, above] at (4,3.2) {\textbf{beaucoup}};
      % Original equilibrium at (3.0, 2.3)
      \filldraw[HECgray] (3.0,2.3) circle (2.5pt);
      \draw[dotted, very thick, HECgray] (0,2.3) node[left] {$P^*$} -- (3.0,2.3);
      % New equilibrium: AD' ∩ AS' → x=2.5, y=3.0
      \filldraw[HECcoral] (2.5,3.0) circle (3pt);
      \draw[dotted, very thick, HECgray] (2.5,0) node[below] {$Y'$} -- (2.5,3.0);
      \draw[dotted, very thick, HECgray] (0,3.0) node[left] {$P'$} -- (2.5,3.0);
   \end{tikzpicture}
   \vspace{-0.2cm}
...
\begin{frame}{Scénario B : Incertitude $\to$ effondrement de l'investissement}
   ...
   \begin{tikzpicture}[scale=1.2]
      ...
      \draw[-{Stealth[length=4pt]}, HECnavy, thick] (4.5,1.4) -- (3.83,1.4);
      \node[font=\footnotesize, HECnavy, above] at (4.17,1.4) {\textit{peu}};
      % Large AS shift arrow: from AS to AS' at y=3.2
      \draw[-{Stealth[length=4pt]}, HECcoral, thick] (4.5,3.2) -- (2.83,3.2);
      \node[font=\footnotesize, HECcoral, above] at (4,3.2) {\textbf{beaucoup}};
      % Original equilibrium at (3.0, 2.3)
