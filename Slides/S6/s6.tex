...
\begin{frame}[t]{Diagramme S-I en économie ouverte}
   ...
   \begin{tikzpicture}[scale=1]
      ...
      \draw[decorate, decoration={brace, amplitude=8pt, mirror}, very thick, HECcoral]
         (2.4,-0.55) -- (3.6,-0.55)
         node[midway, below=8pt, font=\small\bfseries, text=HECcoral] {$CA < 0$ (d\'eficit)}
         node[midway, below=20pt, font=\scriptsize, text=HECcoral] {Importateur net ($CA \approx NX < 0$)};
      % Axes (drawn last for z-order)
      \draw[econaxis] (0,0) -- (6.5,0) node[right] {$S, I$};
      \draw[econaxis] (0,0) -- (0,4.8) node[above] {$r$};
   \end{tikzpicture}
...
\begin{frame}[t]{Le cas inverse : un surplus du compte courant}
   ...
   \begin{tikzpicture}[scale=1]
      % World interest rate (horizontal)
      \draw[HECgreen, very thick, dotted] (0,3.0) -- (6.5,3.0)
         node[right, curvelabel, text=HECgreen] {$r^w$};
      % Reference lines at r^w
      \draw[refline] (4.0,0) node[below, pointlabel] {$S$} -- (4.0,3.0);
      \draw[refline] (2.0,0) node[below, pointlabel] {$I$} -- (2.0,3.0);
      % S curve (HECnavy, upward)
      \draw[very thick, HECnavy] (0,0) -- (5.5,4.125)
         node[right, curvelabel, text=HECnavy] {$S$};
      % I curve (HECcoral, downward)
      \draw[very thick, HECcoral] (0,4.5) -- (6.0,0)
         node[above, curvelabel, text=HECcoral] {$I$};
      % Open-economy allocations at r^w
      \filldraw[eqpoint=HECnavy] (4.0,3.0) circle (2.7pt);
      \filldraw[eqpoint=HECcoral] (2.0,3.0) circle (2.7pt);
      % CA surplus brace
      \draw[decorate, decoration={brace, amplitude=8pt, mirror}, very thick, HECgreen]
         (2.0,-0.55) -- (4.0,-0.55)
         node[midway, below=8pt, font=\small\bfseries, text=HECgreen] {$CA > 0$ (surplus)}
         node[midway, below=20pt, font=\scriptsize, text=HECgreen] {Exportateur net ($CA \approx NX > 0$)};
      % Axes (drawn last for z-order)
      \draw[econaxis] (0,0) -- (6.5,0) node[right] {$S, I$};
      \draw[econaxis] (0,0) -- (0,4.8) node[above] {$r$};
   \end{tikzpicture}
