...
\begin{frame}{Plan}
   \begin{enumerate}
      ...
      \item \textbf{Comment combattre les r\'{e}cessions\,?}
...
% ============================================================================
\sectionframe{Comment combattre les r\'{e}cessions\,?}
% ============================================================================

\begin{frame}{Rappel de la S\'{e}ance 4}
   \vspace{0.3cm}
   \textbf{L'\'{e}conomie peut se corriger seule, mais attendre co\^{u}te cher :}
   \vspace{0.2cm}
   \begin{itemize}
      \setlength\itemsep{0.2cm}
      \item $Y < Y_{\text{POT}}$ $\to$ ch\^{o}mage \'{e}lev\'{e}, faillites, perte de capital humain
      \item L'ajustement naturel (salaires $\downarrow$ $\to$ AS se d\'{e}place) prend des \textbf{ann\'{e}es}
      \item Les coûts sociaux s'accumulent pendant l'attente
   \end{itemize}
   \vspace{0.3cm}
   \begin{keyinsight}
...
\begin{frame}{2020--2022 : un cas d'\'{e}tude grandeur nature}
   ...
   \centering
   \begin{tikzpicture}[
      box/.style={rectangle, rounded corners=8pt, draw=#1, line width=0.8pt,
                  fill=#1!8, minimum width=3.2cm, minimum height=1cm,
                  align=center, font=\small, inner sep=5pt},
      arr/.style={->, >=stealth, line width=1.2pt, #1}]
      \node[box=HECnavy] (a) at (0,0) {\textbf{2020}\\Pand\'{e}mie\\$Y \downarrow\downarrow$};
      \node[box=HECgreen] (b) at (4.5,0) {\textbf{2020--21}\\Relance massive\\BdC $\downarrow$ taux \`{a} 0.25\,\%\\PCU, QE};
      \node[box=HECcoral] (c) at (9,0) {\textbf{2022}\\Inflation \`{a} 8\,\%\\BdC $\uparrow$ taux\\de 0.25 \`{a} 5\,\%};
      \draw[arr=HECnavy] (a) -- (b);
      \draw[arr=HECgreen] (b) -- (c);
   \end{tikzpicture}
   \vspace{0.3cm}
   \begin{keyinsight}
...
\begin{frame}{La r\'{e}ponse politique dans le mod\`{e}le AD-AS}
   \centering
   \begin{tikzpicture}[scale=1.3]
      ...
      % AD' shifted left (recession): y = -0.6x + 3.0
      \draw[HECcoral, very thick] (0.0,3.0) -- (4.5,0.3)
         node[right] {AD$'$};
      % AD'' policy response (close to original but not identical): y = -0.6x + 3.8
      \draw[HECnavy, very thick] (0.3,3.62) -- (5.5,0.5)
         node[right] {AD$''$};
      % Choc arrow (higher, more visible)
      \draw[-{Stealth[length=4pt]}, HECcoral, thick] (3.8,2.4) -- (2.4,2.4);
      \node[font=\scriptsize, HECcoral, above] at (3.1,2.4) {Choc};
      % Policy arrow (lower, more visible)
      \draw[-{Stealth[length=4pt]}, HECnavy, thick] (2.2,0.8) -- (3.6,0.8);
      \node[font=\scriptsize, HECnavy, below] at (2.9,0.8) {Politique};
      % Original equilibrium at AD ∩ AS: (3.0, 2.3)
      \filldraw[HECgray] (3.0,2.3) circle (2.5pt);
      \node[font=\scriptsize, HECgray, above right] at (3.0,2.3) {$E_0$};
      % Recession equilibrium at AD' ∩ AS: (2.08, 1.75)
      \filldraw[HECcoral] (2.08,1.75) circle (2.5pt);
      \node[font=\scriptsize, HECcoral, below left] at (2.08,1.75) {$E_1$};
      % New equilibrium at AD'' ∩ AS: (2.75, 2.15)
      \filldraw[HECnavy] (2.75,2.15) circle (3pt);
      \node[font=\scriptsize, HECnavy, above left] at (2.75,2.15) {$E_2$};
...
\begin{frame}{Plan}
   \begin{enumerate}
      \setlength\itemsep{0.5cm}
      \item {\color{gray!50}Comment combattre les r\'{e}cessions\,?}
...
\begin{frame}[t]{Politique expansionniste : $\downarrow$ taux $\to$ $\uparrow$ AD}
   ...
   \begin{tikzpicture}[scale=0.75]
      ...
      \draw[HECnavy, very thick] (0.3,3.62) -- (5.5,0.5)
         node[right] {AD$''$};
      % Policy arrow
      \draw[-{Stealth[length=4pt]}, HECnavy, thick] (2.0,1.4) -- (3.6,1.4);
      \node[font=\scriptsize, HECnavy, above] at (2.8,1.4) {$\downarrow$ taux};
      % Equilibria
...
\begin{frame}{L'erreur en AD-AS : la relance a d\'{e}pass\'{e} la cible}
   ...
   \begin{tikzpicture}[scale=1.2]
      ...
      % Stimulus arrow
      \draw[-{Stealth[length=5pt]}, HECcoral, thick] (3.2,1.5) -- (5.0,1.5);
      \node[font=\scriptsize, HECcoral, above] at (4.1,1.5) {Relance massive};
...
\begin{frame}{Expansion budg\'{e}taire dans le mod\`{e}le AD-AS}
   ...
   \begin{tikzpicture}[scale=1.3]
      ...
      % Fiscal policy arrow
      \draw[-{Stealth[length=4pt]}, HECnavy, thick] (2.0,1.4) -- (3.6,1.4);
      \node[font=\scriptsize, HECnavy, below] at (2.8,1.4) {$G \uparrow$};
