...
\setbeamertemplate{footline}{%
   ...
   \hbox to \paperwidth{%
      \hspace{1.2cm}%
      {\scriptsize\textcolor{HECgray}{ECON 50803\enspace\textbar\enspace Macroeconomic environment}}%
      \hfill%
...
%
% Logo support: place PNG files in Figures_EN/logos/ (e.g., ft.png, economist.png).
...
\newcommand{\newsheadline}[3][]{%
   ...
   \pgfmathsetmacro{\hlx}{1.2 + \hlcol * 7.3}%
   \pgfmathsetmacro{\hly}{-2.0 - \hlrow * 2.0 - \hlcol * 0.2}%
