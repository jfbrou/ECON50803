...
\setbeamertemplate{footline}{%
   ...
   \hbox to \paperwidth{%
      \hspace{1.2cm}%
      {\scriptsize\textcolor{HECgray}{ECON50803\enspace\textbar\enspace Macroeconomic Environment}}%
      \hfill%
...
\setbeamertemplate{itemize item}{\textcolor{HECnavy}{\scalebox{1.8}{\textbullet}}}
\setbeamertemplate{itemize subitem}{\textcolor{HECgray}{\scalebox{1.5}{\textbullet}}}
...
\usetikzlibrary{decorations.pathreplacing, decorations.markings, calc, arrows.meta}
...
\newcommand{\titleframe}{%
   ...
   \begin{frame}[plain]
      ...
      \vfill
      \hspace{0.6cm}%
      {\footnotesize\textcolor{HECgray}{HEC Montr\'eal \enspace\textbar\enspace MBA}}
      \vspace{0.5cm}
   \end{frame}}%
}
...
\newtcolorbox{bizimplication}[1][Business implication]{%
   colback=HECnavy!5,
   colframe=HECnavy,
   boxrule=0pt,
   leftrule=3pt,
